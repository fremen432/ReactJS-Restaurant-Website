const input_classes = 'w-full px-2 p-1 rounded-lg ContactUs_Fieldset '
...
function submit() {
  ...
  if(phoneField.value.toString().match(phoneREGEX) == null) return alert('Please enter a valid phone number')
  if(emailField.value.toString().match(emailREGEX) == null) return alert('Please enter a valid email address') 
  if (
...
export default function Contact() {
  return (
    <div className=" ContactUs_Wrapper box">
      ...
      <div id="Contact" className="ContactUs_Content shadow-2xl p-2 md:m-0 m-2 rounded-lg">
        <h1 className="ContactUs_Title text-center bg-1 box w-full shadow-md">Contact Us!</h1>
